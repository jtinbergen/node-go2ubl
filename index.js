 ...
 */
const enableCompany = async (chamberOfCommerceId) => {
    return await postToGo2Ubl({
 ...
 */
const disableCompany = async (chamberOfCommerceId) => {
    return await postToGo2Ubl({
 ...
 */
const deleteEmailFromCompanyWhitelist = async (chamberOfCommerceId, emailAddressToDelete) => {
    return await postToGo2Ubl({
 ...
 */
const addEmailToCompanyWhitelist = async (chamberOfCommerceId, emailAddressToAdd) => {
    return await postToGo2Ubl({
 ...
 */
const getCompanyWhitelist = async (chamberOfCommerceId) => {
    return await postToGo2Ubl({
